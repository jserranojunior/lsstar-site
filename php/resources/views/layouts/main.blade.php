...
<div class="modal fade modalPromocao" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
      ...
      <img src="{{Url('/img/promocao/2-casa6.png')}}" class="img-fluid  sombra" alt="Ls Star Incorporadora">
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-74200149-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
  
    gtag('config', 'UA-74200149-1');
  </script>
