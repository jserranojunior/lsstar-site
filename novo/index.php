<?php 
  ...
  <div class="row bg-light row-navbar ">
    <div class="col-md-3">
    <!--
      <div class="col-md-3">
        <div class="logo-topo">
    ...
    <div class="col-md-3">
    <a class="text-primary" target="_blank" href="https://www.facebook.com/lsstarincorporadora/?ref=bookmarks">
          <div class="row">
          ...
          <div class="col">
          <a class=" text-danger" target="_blank" href="https://www.instagram.com/lsstarincorporadora/">
          <span class="icon-social-media-header">
  ...
  <div class="col-lg-3">
    <div class="row justify-content-md-center">
      <div class="widget plugin-facebook">
        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Flsstarincorporadora%2F&tabs=timeline&width=250&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="250" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
      </div>
    </div>
  </div>
</div>
<div class="footer bg-light">
  <div class="row row-space">
    <div class="col  ">
      <h6 class="font-weight-bold text-center">Escritório e Vendas</h6>
      <p class="text-center ">
